      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl">
          <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full px-4 py-2 mb-6 animate-in fade-in duration-700">
            ...
            <span className="text-white/90 text-[14px] font-semibold tracking-wide uppercase">Matériel & Équipements</span>
          </div>
          ...
          <p className="text-xl text-white/70 leading-relaxed max-w-2xl font-sans">
            Optimisez votre infrastructure avec nos solutions matérielles de pointe, 
            sélectionnées auprès des meilleurs constructeurs mondiaux.
          </p>
        </div>
      </div>
    </section>
...
export default EquipementsHero;
